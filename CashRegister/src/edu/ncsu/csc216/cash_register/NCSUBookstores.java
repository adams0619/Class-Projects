...
public class NCSUBookstores {
	...
	/** User input option for sweat shirt */
	private static final int SWEATSHIRT_OPTION = 3;
	/** User input option for baby doll t-shirt */
	...
	public void userInterface() {
		...
		//Boolean used to re-display menu options if incorrect input is entered
		boolean reRun = true;
		//While loop used to loop through menu if incorrect options are selected
		while(reRun) {
			//Prints main menu
			menu();
	...
	public void handleBalance() {
		System.out.printf("Current register balance: $%1$.2f%n", register.getCurrentBalance() / 100.00);
	}
	...
	public void handlePurchase() {
		...
		try {			
			...
			if (itemMenuNumber >= 1 && itemMenuNumber < 6) {
